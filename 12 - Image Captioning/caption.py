...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', default='checkpoints/BEST_checkpoint_flickr8k_5_cap_per_img_5_min_word_freq.pth.tar', help='path to model')
    parser.add_argument('--word_map', '-wm', default='data/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json', help='path to word map JSON')
